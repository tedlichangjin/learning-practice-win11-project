...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-white to-pink-50 flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-400 mt-1">注册后即可开始挑战</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl text-sm font-bold shadow-lg hover:from-purple-600 hover:to-pink-600 transition-all active:scale-[0.98] disabled:opacity-50"
          >
            {loading ? "注册中..." : "注册"}
          </button>
        </form>
